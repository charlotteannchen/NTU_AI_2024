...
def joinFactors(factors: List[Factor]):
    ...
    #     print(F.unconditionedVariables())
    #     print(F.conditionedVariables())
    #     print(F.variableDomainsDict())
    #     unconditioned = F.unconditionedVariables()
    #     conditioned = F.conditionedVariables()
    #     variableDomainsDict = F.variableDomainsDict()
    #     # a = Factor(Factor.unconditionedVariables(), Factor.conditionedVariables(), Factor.variableDomainsDict())
    #     print("##################")
    # typecheck portion
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for assignment in assignments:
            ...
            for eliminate in factor.variableDomainsDict()[eliminationVariable]:
                ...
                # print(eliminationVariable)
                assign = assignment
                assign[eliminationVariable] = eliminate
                # print(assignment)
